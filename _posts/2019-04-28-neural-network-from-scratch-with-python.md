...
Как можно увидеть на графике, кривая тангенса круче, соответсвенно, более чувствительна к изменениям $$x$$. Также стоит заметить, что значения функции находятся в границах [-1,1], что является преимуществом, так как предоставляет возможность выставить пороги позитивного класса в более широком диапазоне.

Функция тангенса подвержена тем же порокам, что и сигмоида, так как имеет с ней общую сущность.
На практике активно применяют и сигмоиду и гиперболический тангенс, а что выбрать зависит от конкретного случая.
